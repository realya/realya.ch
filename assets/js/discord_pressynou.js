$(function() {
    ...
    $('#pressynou-avatar').html('<img class="border rounded-pill border-danger shadow-lg" style="margin-top: 10px;margin-bottom: 10px;" width="150px" src="https://cdn.discordapp.com/avatars/' + donnee.payload.discord.id + '/' + donnee.payload.discord.avatar + '">');
