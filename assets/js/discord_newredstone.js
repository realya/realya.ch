$(function() {
    ...
    $('#newredstone-avatar').html('<img class="border rounded-pill border-danger shadow-lg" style="width: 80px;border-radius: 50px;" width="70px" src="https://cdn.discordapp.com/avatars/' + donnee.payload.discord.id + '/' + donnee.payload.discord.avatar + '">');
